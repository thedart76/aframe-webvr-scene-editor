	...
	init: function () {
		...
		document.body.addEventListener('triggerdown', function () {
            if (transformPositionHovered) {
                ...
                var localAxisHelperWrapper = document.querySelector('#local-axis-helper-wrapper');
                ...
                if (toDelete > 0 && data.axis === 'x') {
                    ...
                    if (data.direction === 'positive') {
                        ...
                        localAxisHelperWrapper.object3D.position.x = incrementPositionX;
                ...
                if (toDelete > 0 && data.axis === 'y') {
                    if (data.direction === 'positive') {
                        ...
                        localAxisHelperWrapper.object3D.position.y = incrementPositionY;
                    } else if (data.direction === 'negative') {
                        incrementPositionY -= parseFloat(data.value.toFixed(2));
                        grabLastCreated.object3D.position.y = incrementPositionY;
                        localAxisHelperWrapper.object3D.position.y = incrementPositionY;
                ...
                if (toDelete > 0 && data.axis === 'z') {
                    if (data.direction === 'positive') {
                        ...
                        localAxisHelperWrapper.object3D.position.z = incrementPositionZ;
                    } else if (data.direction === 'negative') {
                        incrementPositionZ -= parseFloat(data.value.toFixed(2));
                        grabLastCreated.object3D.position.z = incrementPositionZ;
                        localAxisHelperWrapper.object3D.position.z = incrementPositionZ;
...
AFRAME.registerComponent('transform-rotation', {
	...
	init: function () {
        ...
        var rotationWarningWrapper = document.querySelector('#rotation-warning-wrapper');
        var localAxisHelperWrapper = document.querySelector('#local-axis-helper-wrapper');
            ...
            if (transformRotationHovered) {
                ...
                if (toDelete > 0 && data.axis === 'x') {
                    if (data.direction === 'positive') {
                        ...
                        localAxisHelperWrapper.object3D.rotation.x = (Math.PI / 180) * incrementRotationX;
                    } else if (data.direction === 'negative') {
                        incrementRotationX -= data.value;
                        grabLastCreated.object3D.rotation.x = (Math.PI / 180) * incrementRotationX;
                        localAxisHelperWrapper.object3D.rotation.x = (Math.PI / 180) * incrementRotationX;
                ...
                if (toDelete > 0 && data.axis === 'y') {
                    if (data.direction === 'positive') {
                        ...
                        localAxisHelperWrapper.object3D.rotation.y = (Math.PI / 180) * incrementRotationY;
                    } else if (data.direction === 'negative') {
                        incrementRotationY -= data.value;
                        grabLastCreated.object3D.rotation.y = (Math.PI / 180) * incrementRotationY;
                        localAxisHelperWrapper.object3D.rotation.y = (Math.PI / 180) * incrementRotationY;
                ...
                if (toDelete > 0 && data.axis === 'z') {
                    if (data.direction === 'positive') {
                        ...
                        localAxisHelperWrapper.object3D.rotation.z = (Math.PI / 180) * incrementRotationZ;
                    } else if (data.direction === 'negative') {
                        incrementRotationZ -= data.value;
                        grabLastCreated.object3D.rotation.z = (Math.PI / 180) * incrementRotationZ;
                        localAxisHelperWrapper.object3D.rotation.z = (Math.PI / 180) * incrementRotationZ;
                ...
                if (incrementRotationX !== 0 || incrementRotationY !== 0 || incrementRotationZ !== 0) {
                    rotationWarningWrapper.setAttribute('visible', 'true');
                } else {
                    rotationWarningWrapper.setAttribute('visible', 'false');
                }
            }
		});
	}
...
AFRAME.registerComponent('toggle-axis-helpers', {
    init: function () {
        var el = this.el;
        var data = this.data;
        var toggleAxisHelpersHovered = false;
        var toggleAxisHelpersVisible = false;
        var worldAxisHelperWrapper = document.querySelector('#world-axis-helper-wrapper');
        var localAxisHelperWrapper = document.querySelector('#local-axis-helper-wrapper');
        
        el.addEventListener('mouseenter', function () {
			toggleAxisHelpersHovered = true;
		});
        
        el.addEventListener('mouseleave', function () {
			toggleAxisHelpersHovered = false;
		});
        
		document.body.addEventListener('triggerdown', function () {
            if (toggleAxisHelpersHovered && toggleAxisHelpersVisible === false) {
                worldAxisHelperWrapper.setAttribute('visible', 'true');
                localAxisHelperWrapper.setAttribute('visible', 'true');
                toggleAxisHelpersVisible = true;
            } else if (toggleAxisHelpersHovered && toggleAxisHelpersVisible) {
                worldAxisHelperWrapper.setAttribute('visible', 'false');
                localAxisHelperWrapper.setAttribute('visible', 'false');
                toggleAxisHelpersVisible = false;
            }
		});
	}
});
	...
	init: function () {
		...
		document.body.addEventListener('triggerdown', function () {
            if (createEntityHovered) {
                ...
                var localAxisHelperWrapper = document.querySelector('#local-axis-helper-wrapper');
                localAxisHelperWrapper.object3D.position.set(incrementPositionX, incrementPositionY, incrementPositionZ);
                localAxisHelperWrapper.object3D.rotation.set(incrementRotationX, incrementRotationY, incrementRotationZ);
	...
	init: function () {
		...
		document.body.addEventListener('triggerdown', function () {
            if (copyEntityHovered) {
                ...
                var localAxisHelperWrapper = document.querySelector('#local-axis-helper-wrapper');
                localAxisHelperWrapper.object3D.position.set(incrementPositionX, incrementPositionY, incrementPositionZ);
                localAxisHelperWrapper.setAttribute('rotation', copiedRotation);
            }
		});
	}
});
	...
	init: function () {
		...
		document.body.addEventListener('triggerdown', function () {
            if (deleteEntityHovered) {
                ...
                var localAxisHelperWrapper = document.querySelector('#local-axis-helper-wrapper');
                localAxisHelperWrapper.object3D.position.set(0, 0, 0);
                localAxisHelperWrapper.object3D.rotation.set(0, 0, 0);
            }
		});
	}
});
